...
const supabase = createClient(
  ...
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY! // Pode ser preciso usar o SERVICE_ROLE_KEY dependendo do RLS, mas usaremos a ANON aqui pois não há restrições estritas referidas.
);
